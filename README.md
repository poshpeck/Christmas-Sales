<h1>Christmas Sales Insight Dashboard</h1>
...
<b>Dynamic Pricing Optimization</b>
...
<b>Top Products & Payment Method</b>
...
<b>Dynamic Slicers and Filters</b>:
...
- Clone or download the repository containing the Power BI file (.pbix) and dataset files.
- Open the .pbix file in Power BI Desktop.
- Explore the dashboard using interactive filters and slicers to analyze data for specific years, regions, or customer segments.
- Adjust the dynamic pricing slider to simulate changes in product pricing and observe the impact on profit.
